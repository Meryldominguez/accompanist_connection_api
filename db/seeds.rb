...
def create_instruments
  ...
  Instrument.create(name: 'Voice, Soprano')
  Instrument.create(name: 'Voice, Tenor')
...
def create_profiles
  Profile.create(user: @user_meryl, instrument: @instrument_soprano)
  Profile.create(user: @user_meryl, instrument: @instrument_violin)
  Profile.create(user: @user_josh, instrument: @instrument_piano)
