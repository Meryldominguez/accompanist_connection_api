...
Trestle.configure do |config|
  ...
  #
  config.site_title = 'Accompanist Connection Api'
  ...
  #
  config.auth.user_scope = -> { User.admins }
  ...
  #
  config.auth.remember.cookie = lambda { |user|
    { value: user.admin_role.remember_token, expires: user.admin_role.remember_token_expires_at }
  }
end
